    ...
    <section id="chi-sono" className={styles.sezione}>
      <Reveal>
        ...
        <p className={styles.testo} style={{marginTop: "1em"}}>
          Designer multidisciplinare per vocazione (e per noia della monotonia): ho lavorato nel web, nel design, enlla grafica tradizionale, e persiono nella scrittura e nella produzione di videoclip.
